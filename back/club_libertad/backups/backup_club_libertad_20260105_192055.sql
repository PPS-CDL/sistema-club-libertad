...
\restrict 6B75mnDZytxaxRWxTwTBFXoatCS5bg2GIoSbx3lL27w2yV1knqen8KvMBEBSViJ
...
23	GENERADA	2026-01-05	2026-02-01	5000.00	2026-01-01	2	55		\N
24	GENERADA	2026-01-05	2026-02-01	128000.00	2026-01-01	17	55		\N
25	GENERADA	2026-01-05	2026-02-01	12000.00	2026-01-01	16	55		\N
...
SELECT pg_catalog.setval('public.cuota_id_seq', 25, true);
...
SELECT pg_catalog.setval('public.deporte_id_seq', 17, true);
...
SELECT pg_catalog.setval('public.inscripcion_seq', 351, true);
...
SELECT pg_catalog.setval('public.pago_id_seq', 13, true);
...
SELECT pg_catalog.setval('public.persona_id_seq', 67, true);
...
SELECT pg_catalog.setval('public.promocion_id_seq', 4, true);
...
SELECT pg_catalog.setval('public.registro_id_seq', 12, true);
...
\unrestrict 6B75mnDZytxaxRWxTwTBFXoatCS5bg2GIoSbx3lL27w2yV1knqen8KvMBEBSViJ
